...
public class AdController {
    ...
    @GetMapping("/filter")
    public ResponseEntity<List<AdDTO>> searchAdsByCriteria(@RequestParam(name = "category", required = false)       String category,
        ...
        AdSearchCriteria searchCriteria = new AdSearchCriteria(category, type, county, city, minPrice, maxPrice, minUsableArea, maxUsableArea);
        List<AdDTO> ads = adService.getAdsByCriteria(searchCriteria);
